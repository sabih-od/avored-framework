<template>
    <div>
        <div class="btn-container p-2" v-if="editor">
            <button @click.prevent="editor.chain().focus().toggleBold().run()"
                    class="btn btn-outline-secondary btn-sm mb-2 mr-2 mb-2 mr-2"
            ...
            <button class="btn btn-outline-secondary btn-sm mb-2 mr-2"
        ...
        <textarea class="hidden" ref="textAreaContent" :name="tagName"></textarea>
    </div>
</template>
...
export default {
    ...
    mounted() {
        if(this.modelValue && this.$refs['textAreaContent'])
            this.$refs['textAreaContent'].value = this.modelValue
        ...
        this.editor = new Editor({
            ...
            onUpdate: () => {
                ...
                if(this.$refs['textAreaContent'])
                    this.$refs['textAreaContent'].value = this.editor.getHTML()
