    ...
    <div id="vapp">
        <div class="p-5">
            ...
            <div class="mt-5 w-full">
                <x-avored::form.form action="{{ route('admin.recipe.store') }}" method="POST"
                    ...
                    <div class="flex w-full">
                        <div class="w-1/2">
                            <div class="mt-3">
                                ...
                                <editor model-value="{{ old('ingredients') }}" tag-name="ingredients"></editor>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex w-full">
                        <div class="w-1/2">
                            <div class="mt-3">
                                ...
                                <editor model-value="{{ old('description') }}" tag-name="description"></editor>
                            </div>
                        </div>
                    </div>
