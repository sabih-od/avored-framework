    ...
    <div>
        <div class="p-5">
            ...
            <div class="mt-5 w-full">
                <x-avored::form.form action="{{ route('admin.admin-chat-message.store') }}" method="POST"
                    ...
                    <div class="mt-6 flex">
                        ...
                        <x-avored::link url="{{ route('admin.admin-chat-message.index') }}" class="ml-3" style="button-default">
                            Cancel
                        </x-avored::link>
                    </div>
                </x-avored::form.form>
