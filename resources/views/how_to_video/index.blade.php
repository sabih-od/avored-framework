    ...
    <div>
        <div class="p-5">
            <div class="flex w-full">
                ...
                <span class="ml-auto">
                <x-avored::link url="{{ route('admin.how-to-video.create') }}"
                        ...
                        <x-slot name="body">
                            @foreach ($list as $item)
                                <x-avored::table.row class="">
                                    ...
                                    <x-avored::table.cell>
                                        <div class="flex">
                                            <x-avored::link url="{{ route('admin.how-to-video.edit', $item) }}">
                                                <i class="w-5 h-5" data-feather="edit"></i>
                                            </x-avored::link>
                                            <x-avored::form.form action="{{ route('admin.how-to-video.destroy', $item) }}"
                                                                 method="DELETE">
                                                <button type="submit">
